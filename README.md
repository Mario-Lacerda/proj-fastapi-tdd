...
Neste tutorial, você aprenderá a criar uma API com FastAPI utilizando TDD. TDD significa Test Driven Development, ou Desenvolvimento Orientado a Testes. É uma metodologia de desenvolvimento de software que enfatiza a escrita de testes antes do código. Isso ajuda a garantir que o código esteja funcionando corretamente e que novos recursos sejam facilmente adicionados.

FastAPI é um framework Python moderno e de alto desempenho para criar APIs. Ele é rápido, flexível e fácil de usar. TDD é uma técnica que pode ser usada com qualquer framework de desenvolvimento de software, mas ela é especialmente adequada para FastAPI, pois ajuda a garantir que sua API seja bem estruturada e fácil de manter.



## Criação da API

Para começar, criaremos uma API simples que retorna uma lista de números. O primeiro passo é criar um projeto Python. Você pode fazer isso usando o comando `python3 -m venv venv`. Em seguida, ative o ambiente virtual usando o comando `source venv/bin/activate`.

Agora, vamos instalar o FastAPI e o pytest usando os seguintes comandos:
...
Agora, criaremos um arquivo chamado `main.py`. Este arquivo conterá a lógica de nossa API. O código abaixo cria uma API simples que retorna uma lista de números:
...
Agora, vamos escrever alguns testes para nossa API. Os testes são escritos usando o pytest. O código abaixo cria um teste que verifica se a API está retornando a lista correta de números:
...
O teste deve ser bem-sucedido, o que indica que nossa API está funcionando corretamente.



## Conclusão

Como criar uma API com FastAPI utilizando TDD. TDD é uma metodologia de desenvolvimento de software que enfatiza a escrita de testes antes do código. Isso ajuda a garantir que o código esteja funcionando corretamente e que novos recursos sejam facilmente adicionados. FastAPI é um framework Python moderno e de alto desempenho para criar APIs. Ele é rápido, flexível e fácil de usar. TDD é uma técnica que pode ser usada com qualquer framework de desenvolvimento de software, mas ela é especialmente adequada para FastAPI, pois ajuda a garantir que sua API seja bem estruturada e fácil de manter.
...
# FastAPI Workshop -  Mais completa com CRUD
